...
if __name__ == "__main__":
    ...
    """parts = {
        ...
        'baseline_2': [['baseline/conv5','baseline/conv6','baseline/conv7','baseline/conv8','baseline/conv9','baseline/conv10'], 0],
        'baseline_3': [['baseline/conv11', 'baseline/conv12', 'baseline/conv13', 'baseline/fc3', 'baseline/fc4', 'baseline/logits_exit2'], 0],
        'exit0': [['exit0/fc1', 'exit0/fc2', 'exit0/logits_exit0'], 0],
        'exit1': [['exit1/fc1', 'exit1/fc2', 'exit1/logits_exit1'], 0]
    }
"""
    parts = {
        'baseline_1': [['baseline/conv1', 'baseline/conv2','baseline/conv3', 'baseline/conv4'], 0],
