...
class Solver(object):
    ...
    def __init__(self, config):
        ...
        self.baseline_epoch = config.baseline_epoch
        self.train_step = None
        self.test_step = None
        self.checkpoint_path = config.checkpoint_path
        self.auto_earlyexit_lossweights = config.auto_earlyexit_lossweights
    ...
    def train(self):
        ...
        #opt_exit0 = tf.train.AdamOptimizer(learning_rate=self.lr, beta1=0.99, beta2=0.999)
        #opt_exit1 = tf.train.AdamOptimizer(learning_rate=self.lr, beta1=0.99, beta2=0.999)

        #opt_exit2 = tf.train.AdamOptimizer(learning_rate=self.lr, beta1=0.99, beta2=0.999)
        ...
        # save training record into a pickle file
        #write_pickle(training_record, 'training_record.pickle')
